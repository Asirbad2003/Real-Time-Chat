...
function Register() {
  ...
  return (
    <div className='bg-[#121418] w-[100vw] h-[100vh] flex justify-center items-center'>
      <div className='w-[90%] sm:w-[400px] pl-0 ml-0 h-[500px] sm:pl-0 sm:ml-9 mt-20 relative'>
        ...
        <form className='flex flex-col gap-y-3 mt-[12%]' onSubmit={handleOnSubmit}>
          <div>
            <input className="w-[100%] sm:w-[80%] bg-[#222222] h-[50px] pl-3 text-[#ffff]" onChange={handleOnChange} name="firstname" type="text" placeholder='First Name' value={formData.firstname} required />
          </div>
          <div>
            <input className="w-[100%] sm:w-[80%] bg-[#222222] h-[50px] pl-3 text-[#ffff]" onChange={handleOnChange} name="lastname" type="text" placeholder='Last Name' value={formData.lastname} required />
          </div>
          <div>
            <input className="w-[100%] sm:w-[80%] bg-[#222222] h-[50px] pl-3 text-[#ffff]" onChange={handleOnChange} name="email" type="email" placeholder='Email' value={formData.email} required />
          </div>
